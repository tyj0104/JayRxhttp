...
public class RxHttp {
    ...
    @Setter
    private static com.pajf.library.http.SSLConfig defaultSSLConfig = com.pajf.library.http.SSLConfig.newBuilder().trustAll(true).create();
    ...
    public static class Builder {
         ...
         * 设置SSL选项
         */
        public Builder setSslConfig(com.pajf.library.http.SSLConfig sslConfig) {
    ...
    /*ssl选项*/
    private com.pajf.library.http.SSLConfig sslConfig = defaultSSLConfig;
    /*gson*/
    private Gson gson;
    /*User-Agent*/
    ...
    private com.pajf.library.http.RxHttp.HttpApi create(String url) {
        ...
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
                .addInterceptor(com.pajf.library.http.OkHttp3Utils.userAgentInterceptor(userAgent))
                .addInterceptor(com.pajf.library.http.OkHttp3Utils.newLogger(logLevel))
        ...
        return new Retrofit.Builder()
                ...
                .build()
                .create(com.pajf.library.http.RxHttp.HttpApi.class);
    }
    ...
    private <T> Observable<T> post0(String url, Map<String, String> headers, Class<T> type) {
        ...
        String path = array[1];
        String params = array[2];
        RequestBody body = RequestBody.create(com.pajf.library.http.OkHttp3Utils.application_x_www_form_urlencoded, StringUtils.getBytesUtf8(params));
    ...
    public <T> Observable<T> postJson(String url, Object json, Map<String, String> headers, Class<T> type) {
        ...
        RequestBody body = RequestBody.create(com.pajf.library.http.OkHttp3Utils.application_json, data);
        return create(url).post(path, headers, body)
                .map(resp -> resp2obj(resp, type));
    }
    ...
    public <T> Observable<T> post(String url, byte[] data, Map<String, String> headers, Class<T> type) {
        ...
        url = array[0];
        String path = array[1];
        RequestBody body = RequestBody.create(com.pajf.library.http.OkHttp3Utils.application_octet_stream, data);
        return create(url).post(path, headers, body)
                .map(resp -> resp2obj(resp, type));
    }
    ...
    public <T> Observable<T> postMultiParts(String url, Map<String, Object> multiParts, Map<String, String> headers, Class<T> type) {
        ...
        for (Map.Entry<String, Object> e : multiParts.entrySet()) {
            ...
            } else if (value instanceof com.pajf.library.http.MockFile) {
...
//    private boolean syncServerTime;
//
//    private HttpApi create(String url) {
//        HttpLoggingInterceptor.Level logLevel = debug ? HttpLoggingInterceptor.Level.BODY : HttpLoggingInterceptor.Level.NONE;
//
//        OkHttpClient.Builder builder = new OkHttpClient.Builder()
...
//     */
//    public Observable<String> get(String url, String params) {
//        return get0(appendURL(url, params), EMPTY_HEADERS);
//    }
//
//    /**
//     * GET请求
...
//     */
//    public Observable<String> get(String url, Map<String, String> params) {
//        return get0(appendURL(url, map2string(params)), EMPTY_HEADERS);
//    }
//
//    /**
//     * GET请求
...
//     */
//    public Observable<String> get(String url, String params, Map<String, String> headers) {
//        return get0(appendURL(url, params), headers);
//    }
//
//    /**
//     * GET请求
...
//     */
//    public Observable<String> get(String url, Map<String, String> params, Map<String, String> headers) {
//        return get0(appendURL(url, map2string(params)), headers);
//    }
//
//    private Observable<String> get0(String url, Map<String, String> headers) {
//        String[] array = splitURL(url, true);
//        url = array[0];
//        String path = array[1];
//        String params = array[2];
//        return create(url).get(path, headers, string2map(params))
//                .map(resp -> resp.string());
//    }
//
//
//    /**
...
//     */
//    public Observable<String> post(String url) {
//        return post0(url, EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> post(String url, String params) {
//        return post0(appendURL(url, params), EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> post(String url, Map<String, String> params) {
//        return post0(appendURL(url, map2string(params)), EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> post(String url, String params, Map<String, String> headers) {
//        return post0(appendURL(url, params), headers);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> post(String url, Map<String, String> params, Map<String, String> headers) {
//        return post0(appendURL(url, map2string(params)), headers);
//    }
//
//    private Observable<String> post0(String url, Map<String, String> headers) {
//        String[] array = splitURL(url, true);
//        url = array[0];
//        String path = array[1];
//        String params = array[2];
...
//     */
//    public Observable<String> postJson(String url, Object json) {
//        return postJson(url, json, EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> post(String url, byte[] data) {
//        return post(url, data, EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
...
//     */
//    public Observable<String> postMultiParts(String url, Map<String, Object> multiParts) {
//        return postMultiParts(url, multiParts, EMPTY_HEADERS);
//    }
//
//    /**
//     * POST请求
